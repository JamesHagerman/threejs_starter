var Socket = (function() {
    return {
        cookie_name: "family_meeting_test",
        socket: null,
        init: function() {
...
var Three = (function() {
    return {
        ...
        init: function() {
            ...
            this.material_phong = new THREE.MeshPhongMaterial({ ambient: 0xffffff, color: 0xff0000, specular: 0x009900, shininess: 30, shading: THREE.FlatShading, emissive: 0x111111 });
